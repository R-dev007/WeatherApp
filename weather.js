...
const fetchWeatherData = async (cityLogitude, cityLatitude) => {
  try {
    const response = await fetch(
      `https://api.openweathermap.org/data/2.5/weather?lat=${cityLatitude}&lon=${cityLogitude}&appid=36c18898c3ea9505571a7816c80ecd2a`,
      {
        method: "GET",
      }
    );
...
const forecastData = async (cityLogitude, cityLatitude) => {
  try {
    const response = await fetch(
      `https://api.openweathermap.org/data/2.5/forecast?&lat=${cityLatitude}&lon=${cityLogitude}&cnt=7&appid=36c18898c3ea9505571a7816c80ecd2a`,
